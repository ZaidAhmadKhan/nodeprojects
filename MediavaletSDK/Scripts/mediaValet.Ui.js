                       ...
                       * screenname variable is a global variable and used for matainning page state
                        */
                        ...
                        if (token == null || token == undefined) {
                            ...
                            offsetcount = 0; 
                            var assets = mvCore.SearchingAssets(searchtext, token, 'filters', sorting, searchingimagecount, offsetcount); //0
                ...
                try {
                    if (checkstatus == false) {
                        ...
                        if (token != null || token != undefined) {
                            ...
                            var recentlyviwed = mvCore.GetAssets('filter', token, 0, count);
                    ...
                    if (checkstatus == false) {
                        ...
                        if (token == null || token == undefined) {
                          ...
                          //set cookies values current view
                            ...
                            var mostviwed = mvCore.GetAssets('filter', token, 0, count);
                ...
                try {
                    ...
                    if (checkstatus == false) {
                        ...
                        if (token == null || token == undefined) {
                            ...
                            var categoryassets = mvCore.GetAssets('filter', token, 0, count);
            ...
            AutoLoadAssetBinding: function () {
                try {
                    ...
                    if (token == null && token == undefined) {
                        ...
                        $('#errormessagediv').css('display', 'none');
                        $('#errormessagediv').html('');
                        var recentlyviwed = mvCore.GetAssets('filter', token, offsetcount, imagecountonscroll);
                        $.when(recentlyviwed).done(function (assetdata) {
                            if (assetdata.errormessage == null || assetdata.errormessage == undefined) {
                ...
                try {
                    ...
                    * screenname variable is a global variable and used for maintaining page state
                    ...
                    if (token == null || token == undefined) {
                        ...
                        var assets = mvCore.SearchingAssets(searchtext, token, 'filters', sortings, searchcount, offsetcount);
                        $.when(assets).done(function (assetdata) {
                            if (assetdata.errormessage == null || assetdata.errormessage == undefined) {
                                if (assetdata.payload.assetCount >= offsetcount) {
                                    var actualoffsetcount = '';
                ...
                if (defaultsettings.apps == "office") {
                    ...
                    if (mvAppSdkCore.ApplicationName != undefined) {
                        ...
                        if (globalappname == undefined) {
                            globalappname = 'word';
                            mvCore.SetCookies('cookiesappname', 'office', 360);
                        }
                    } else {
                        //Tracking Asset App name
                        globalappname = 'word';
                        //Office in case of App Name 
                        mvCore.SetCookies('cookiesappname', 'office', 360);
                    }
                }
                else  {
                    ...
                    mvCore.SetCookies('cookiesappname', globalappname, 360);
                } 
            },
